...
const getInvitations = async (userId) => {
  try {
    ...
    // Vì các dữ liệu inviter, invitee và board là đang ở giá trị mảng 1 phần tử nếu lấy ra được nên chúng ta biến đổi nó về Json Object trước khi trả về
...
const updateBoardInvitation = async (userId, invitationId, status) => {
  try {
    ...
    // console.log('boardOwnerAndMemberIds: ', boardOwnerAndMemberIds)
