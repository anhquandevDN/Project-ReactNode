 ...
 */
function CardDescriptionMdEditor({ cardDesctiptionProp, handleUpdateCardDescription }) {
  ...
  const [cardDescription, setCardDescription] = useState(cardDesctiptionProp)

  const updateCardDescription = () => {
    setMarkdownEditMode(false)
    // console.log('cardDesctiptionProp: ', cardDesctiptionProp)
