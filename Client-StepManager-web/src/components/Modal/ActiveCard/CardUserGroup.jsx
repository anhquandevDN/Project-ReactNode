...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Đoạn này lấy board từ redux ra để mục đích lấy được toàn bộ user trong board (board.FE_allUsers)
  const board = useSelector(selectCurrentActiveBoard)

  /**
   * Thành viên trong card chắc chắn phải là tập con của thành viên trong board
  ...
  // Function xử lý dữ liệu để cập nhật card members
          ...
          {board?.FE_allUsers?.map((user, index) =>
            <Tooltip title={user.displayName} key={index}>
              ...
              <Badge
                ...
                // Nếu user đã là thành viên của card thì mới hiện cái tích xanh CheckCircleIcon
