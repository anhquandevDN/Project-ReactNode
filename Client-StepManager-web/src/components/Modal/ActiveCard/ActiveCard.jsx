...
function ActiveCard() {
  ...
  const handleCloseModal = () => {
    // setIsOpen(false)
    // Clear data activeCard trong redux, đưa nó về null, đồng nghĩa với việc ở pages/Boards/_id.jsx sẽ không render cái component ActiveCard nữa
  ...
  const onUpdateCardTitle = (newTitle) => {
    updateCard({ title: newTitle.trim() })
  }
  ...
  return (
    <Modal
      disableScrollLock
      // open={isOpen}
      open={true} // luôn luôn set là true bởi chúng ta xử lý đóng mở modal dựa vào data activeCard từ Redux nhé
      ...
      <Box sx={{
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={9}>
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontWeight: '600', color: 'primary.main', mb: 1 }}>Assigned Members</Typography>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <CardDescriptionMdEditor
                cardDesctiptionProp={activeCard?.description}
