 ...
 */
function SidebarCreateBoardModal({ afterCreatedBoard }) {
  ...
  // <>...</> nhắc lại chưa biết hoặc quên nhé: nó là React Fragment, dùng để bọc các phần tử lại mà không cần chỉ định DOM Node cụ thể nào cả.
  return (
    <>
