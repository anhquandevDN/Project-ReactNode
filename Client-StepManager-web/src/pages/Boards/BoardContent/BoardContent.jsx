  ...
  const moveCardBetweenDifferentColumns = (
    ...
    setOrderedColumns(prevColumns => {
      ...
      if (triggerFrom === 'handleDragEnd') {
        /**
         * Gọi lên props function moveCardToDifferentColumn nằm ở component cha ngay phía trên nó (boards/_id.jsx)
         * Đoạn này khuyến khích giữ nguyên bởi vì code trong BoardContent đã khá nhiều rồi, với cả chỉ gọi lên 1 cấp Props cha thì không vấn đề gì mà còn gọn gàng hơn
         */
  ...
  const handleDragEnd = (event) => {
    ...
    if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.CARD) {
      ...
      if (oldColumnWhenDraggingCard._id !== overColumn._id) {
        ...
        /**
         * Gọi lên props function moveCardInTheSameColumn nằm ở component cha ngay phía trên nó (boards/_id.jsx)
         * Đoạn này khuyến khích giữ nguyên bởi vì code trong BoardContent đã khá nhiều rồi, với cả chỉ gọi lên 1 cấp Props cha thì không vấn đề gì mà còn gọn gàng hơn.
         */
    ...
    if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.COLUMN) {
      ...
      if (active.id !== over.id) {
        ...
        /**
         * Gọi lên props function moveColumns nằm ở component cha ngay phía trên nó (boards/_id.jsx)
         * Đoạn này khuyến khích giữ nguyên bởi vì code trong BoardContent đã khá nhiều rồi, với cả chỉ gọi lên 1 cấp Props cha thì không vấn đề gì mà còn gọn gàng hơn
        */
