...
function ListColumns({ columns }) {
  ...
  // Lấy dữ liệu trong kho Redux ra sử dụng luôn thay vì cần từ component Board/_id.jsx
  ...
  const addNewColumn = async () => {
    ...
    /**
     * Ngoài ra cách nữa là vẫn có thể dùng array.concat thay cho push như docs của Redux Toolkit ở trên vì push như đã nói nó sẽ thay đổi giá trị mảng trực tiếp, còn thằng concat thì nó tạo ra một mảng mới để chúng ta gán lại giá trị nên không vấn đề gì.
     */
