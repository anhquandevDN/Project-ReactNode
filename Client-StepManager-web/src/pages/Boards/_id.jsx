...
import { updateCurrentActiveBoard, selectCurrentActiveBoard, fetchBoardDetailsAPI } from '~/redux/activeBoard/activeBoardSlice'
...
function Board() {
  ...
  useEffect(() => {
    // Call API: cần dispatch vì hàm fetchBoardDetailsAPI là từ middleware của Redux Toolkit
  ...
  const moveColumns = (dndOrderedColumns) => {
    ...
    /**
     * Trường hợp dùng Spread Operator này thì lại không sao (ảo chưa :D) bởi vì ở đây chúng ta không can thiệp sâu xuống hẳn các tầng dữ liệu dưới board, nói chung cứ hiểu đơn giản không bị coi là mutating mà chỉ đang gán lại toàn bộ giá trị columns với columnOrderIds ở tầng thứ nhất của board. Tuwong tự như cách làm concat ở trường hợp createNewColumn thôi :))
     */
  ...
  const moveCardToDifferentColumn = (currentCardId, prevColumnId, nextColumnId, dndOrderedColumns) => {
    ...
    // Xử lý vấn đề khi kéo Card cuối cùng ra khỏi Column, Column rỗng sẽ có placeholder card, cần xóa nó đi trước khi gửi dữ liệu lên cho phía BE. (vd 37.2)
